        ...
        <ul className='user'>
            {
                !loggedIn ? (
                    <li className='user item sign'>
                        <Link to='/login' title='Sign In'>Sign In</Link> or <Link title='Register' to='/register'>Register</Link>
                    </li>
                ) : (
                    <li className='user item auth' onMouseEnter={() => setDropdown(true)} onMouseLeave={() => setDropdown(false)}>
                        ...
                        <b>{user.first_name}</b>
                        <CSSTransition timeout={500} classNames={'fade'} in={dropdown} mountOnEnter={true} unmountOnExit={true}>
