    ...
    return (
        <div className='my-shop manage'>
            <header className='my-shop manage header'>
                <Link to='/my-shop' id='shop' onClick={handlePageSelect} title='My Shop' className={`my-shop manage header logo${page === 'shop' ? ' active' : ''}`}>
                ...
                <ul className='my-shop manage header actions'>
                    <Link to='/my-shop/products' id='products' onClick={handlePageSelect} title='Products' className={`my-shop manage header actions item${page === 'products' ? ' active' : ''}`}>                        
                    ...
                    <Link to='/my-shop/sold' id='sold' onClick={handlePageSelect} title='Sold' className={`my-shop manage header actions item${page === 'sold' ? ' active' : ''}`}>                        
                    ...
                    <Link to='/my-shop/sales' id='sales' onClick={handlePageSelect} title='Sales' className={`my-shop manage header actions item${page === 'sales' ? ' active' : ''}`}>                        
